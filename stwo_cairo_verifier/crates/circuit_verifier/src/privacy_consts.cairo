...
/// Number of Blake gates in the recursive verification circuit. Drives the
/// Blake-IV public logup contribution in `circuit_air::lookup_sum`.
/// TODO(circuit-verifier): replace with the real count.
pub const N_BLAKE_GATES: u32 = 0;

/// Variable indices of the recursive verification circuit's `Output` gates.
/// TODO(circuit-verifier): replace with real values.
pub fn output_addresses() -> Array<u32> {
    array![]
}
