...
// `eq` is handwritten (not produced by stwo-air-infra); appended after the generated indices.
pub const EQ_COMPONENT_IDX: usize = 10;
...
pub const N_TRACE_COLUMNS_PER_COMPONENT_IDX: [usize; N_COMPONENTS] = [
    ...
    triple_xor::N_TRACE_COLUMNS, eq::N_TRACE_COLUMNS,
];
