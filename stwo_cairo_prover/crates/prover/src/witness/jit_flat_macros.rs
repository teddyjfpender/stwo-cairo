//! Macro-generated accessors between the witness-JIT lane's word-major flat
...
//!
//! Layout contract (must match the CUDA codegen + `launch_recorded_witness_for_
//! prove`): flats are WORD-MAJOR, `words[w * n_rows + r]`, so each 16-lane
