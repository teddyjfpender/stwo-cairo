...
//
// GENERATED by tools/witness_genericize for `pedersen_aggregator_window_bits_18` — mechanical rewrite of
...
/// `pedersen_aggregator_window_bits_18_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
