        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, jump_opcode_abs_input))| {
                ...
                *row[2] = input_fp_col2;
                ...
                let memory_address_to_id_value_tmp_6e19b_0 =
                    memory_address_to_id_state.deduce_output(input_pc_col0);
                let memory_id_to_big_value_tmp_6e19b_1 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_6e19b_0);
                let offset2_tmp_6e19b_2 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6e19b_1.get_m31(3)))
                        >> (UInt16_5))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_6e19b_1.get_m31(4),
                        )) << (UInt16_4)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_6e19b_1.get_m31(5),
                        )) & (UInt16_7))
                            << (UInt16_13)));
                let offset2_col3 = offset2_tmp_6e19b_2.as_m31();
                *row[3] = offset2_col3;
                let op1_base_fp_tmp_6e19b_3 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6e19b_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_6e19b_1.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_3))
                        & (UInt16_1));
                let op1_base_fp_col4 = op1_base_fp_tmp_6e19b_3.as_m31();
                *row[4] = op1_base_fp_col4;
                let ap_update_add_1_tmp_6e19b_4 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_6e19b_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_6e19b_1.get_m31(6),
                        ...
                        >> (UInt16_11))
                        & (UInt16_1));
                let ap_update_add_1_col5 = ap_update_add_1_tmp_6e19b_4.as_m31();
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let decode_instruction_1f0a3_output_tmp_6e19b_5 = (
                    [
                        M31_2147483646,
                        M31_2147483646,
                ...
                let mem1_base_col6 = (((op1_base_fp_col4) * (input_fp_col2))
                    + ((decode_instruction_1f0a3_output_tmp_6e19b_5.1[4]) * (input_ap_col1)));
                *row[6] = mem1_base_col6;
                ...
                let memory_address_to_id_value_tmp_6e19b_6 = memory_address_to_id_state
                    .deduce_output(
                        ((mem1_base_col6) + (decode_instruction_1f0a3_output_tmp_6e19b_5.0[2])),
                    );
                let next_pc_id_col7 = memory_address_to_id_value_tmp_6e19b_6;
                ...
                *lookup_data.memory_address_to_id_1 = [
                ...
                let memory_id_to_big_value_tmp_6e19b_8 =
                    memory_id_to_big_state.deduce_output(next_pc_id_col7);
                let next_pc_limb_0_col8 = memory_id_to_big_value_tmp_6e19b_8.get_m31(0);
                *row[8] = next_pc_limb_0_col8;
                let next_pc_limb_1_col9 = memory_id_to_big_value_tmp_6e19b_8.get_m31(1);
                *row[9] = next_pc_limb_1_col9;
                let next_pc_limb_2_col10 = memory_id_to_big_value_tmp_6e19b_8.get_m31(2);
                *row[10] = next_pc_limb_2_col10;
                let next_pc_limb_3_col11 = memory_id_to_big_value_tmp_6e19b_8.get_m31(3);
                *row[11] = next_pc_limb_3_col11;
                ...
                let partial_limb_msb_tmp_6e19b_9 =
                    (((PackedUInt16::from_m31(next_pc_limb_3_col11)) & (UInt16_2)) >> (UInt16_1));
                let partial_limb_msb_col12 = partial_limb_msb_tmp_6e19b_9.as_m31();
                ...
                *lookup_data.memory_id_to_big_2 = [
                ...
                let read_positive_known_id_num_bits_29_output_tmp_6e19b_11 =
                ...
                let enabler_col13 = enabler_col.packed_at(row_index);
                *row[13] = enabler_col13;
                ...
                *lookup_data.mults_1 = enabler_col13;
            },
        );
...
//
// GENERATED by tools/witness_genericize for `jump_opcode_abs` — mechanical rewrite of
...
const N_LOOKUP_WORDS: usize = 51;
const N_SUB_INPUT_WORDS: usize = 9;

/// The per-row `jump_opcode_abs` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn jump_opcode_abs_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let ap_update_add_1_tmp_6e19b_4 = eval.u16_and(wg_v26, 1);
    let ap_update_add_1_col5 = eval.u16_as_m31(ap_update_add_1_tmp_6e19b_4);
    ...
    let wg_v33 = eval.m31_add(m31_2, wg_v32);
    ...
    let wg_v40 = eval.m31_add(m31_2, wg_v39);
    ...
    let wg_v44 = eval.m31_mul(
        decode_instruction_1f0a3_output_tmp_6e19b_5.1[4],
        input_ap_col1,
    );
    ...
    let wg_v45 = eval.m31_add(
        mem1_base_col6,
        decode_instruction_1f0a3_output_tmp_6e19b_5.0[2],
    );
    let memory_address_to_id_value_tmp_6e19b_6 = eval.mem_addr_to_id(wg_v45);
    let next_pc_id_col7 = memory_address_to_id_value_tmp_6e19b_6;
    ...
    let partial_limb_msb_tmp_6e19b_9 = eval.u16_shr(wg_v49, 1);
    let partial_limb_msb_col12 = eval.u16_as_m31(partial_limb_msb_tmp_6e19b_9);
    eval.set_col(12, partial_limb_msb_col12);
    eval.set_sub_input_word(8, next_pc_id_col7);
    eval.set_lookup_word(11, m31_1662111297);
    eval.set_lookup_word(12, next_pc_id_col7);
    eval.set_lookup_word(13, next_pc_limb_0_col8);
    eval.set_lookup_word(14, next_pc_limb_1_col9);
    eval.set_lookup_word(15, next_pc_limb_2_col10);
    eval.set_lookup_word(16, next_pc_limb_3_col11);
    ...
    let read_positive_known_id_num_bits_29_output_tmp_6e19b_11 = eval.felt_from_limbs([
        next_pc_limb_0_col8,
        next_pc_limb_1_col9,
        next_pc_limb_2_col10,
        next_pc_limb_3_col11,
    ...
    let wg_v50 = eval.m31_mul(next_pc_limb_1_col9, m31_512);
    let wg_v51 = eval.m31_add(next_pc_limb_0_col8, wg_v50);
    let wg_v52 = eval.m31_mul(next_pc_limb_2_col10, m31_262144);
    let wg_v53 = eval.m31_add(wg_v51, wg_v52);
    let wg_v54 = eval.m31_mul(next_pc_limb_3_col11, m31_134217728);
    let wg_v55 = eval.m31_add(wg_v53, wg_v54);
    eval.set_lookup_word(46, wg_v55);
    let wg_v56 = eval.m31_add(input_ap_col1, ap_update_add_1_col5);
    eval.set_lookup_word(47, wg_v56);
    eval.set_lookup_word(48, input_fp_col2);
    eval.set_lookup_word(49, m31_1);
    eval.set_lookup_word(50, enabler_col13);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `jump_opcode_abs_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, jump_opcode_abs_input))| {
                let mut eval = SimdWitnessEval::new(
                    ...
                    memory_address_to_id_state,
                    memory_id_to_big_state,
                    jump_opcode_abs_input,
                    row_index,
                    &enabler_col,
                    N_LOOKUP_WORDS,
                    N_SUB_INPUT_WORDS,
                );
                jump_opcode_abs_row_body(&mut eval);
                ...
                *sub_component_inputs.memory_id_to_big[0] = sw[8];
            },
        );
    (trace, lookup_data, sub_component_inputs)
}
...
/// Record the `jump_opcode_abs` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_jump_opcode_abs() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::new("jump_opcode_abs");
    jump_opcode_abs_row_body(&mut eval);
    eval.finish()
}
