...
fn write_trace_simd(
    ...
    (
        ...
        .for_each(|(row_index, (row, lookup_data, sub_component_inputs))| {
            ...
            let instance_addr_tmp_7cd2f_0 = (((seq) * (M31_3))
                + (PackedM31::broadcast(M31::from(pedersen_builtin_segment_start))));

            // Read Id.

            let memory_address_to_id_value_tmp_7cd2f_1 =
                memory_address_to_id_state.deduce_output(instance_addr_tmp_7cd2f_0);
            let input_state_0_id_col0 = memory_address_to_id_value_tmp_7cd2f_1;
            *row[0] = input_state_0_id_col0;
            *sub_component_inputs.memory_address_to_id[0] = instance_addr_tmp_7cd2f_0;
            *lookup_data.memory_address_to_id_0 = [
            ...
            let memory_address_to_id_value_tmp_7cd2f_3 =
                memory_address_to_id_state.deduce_output(((instance_addr_tmp_7cd2f_0) + (M31_1)));
            let input_state_1_id_col1 = memory_address_to_id_value_tmp_7cd2f_3;
            *row[1] = input_state_1_id_col1;
            *sub_component_inputs.memory_address_to_id[1] = ((instance_addr_tmp_7cd2f_0) + (M31_1));
            *lookup_data.memory_address_to_id_1 = [
                M31_1444891767,
                ((instance_addr_tmp_7cd2f_0) + (M31_1)),
                input_state_1_id_col1,
            ];

            // Read Id.

            let memory_address_to_id_value_tmp_7cd2f_5 =
                memory_address_to_id_state.deduce_output(((instance_addr_tmp_7cd2f_0) + (M31_2)));
            let output_state_id_col2 = memory_address_to_id_value_tmp_7cd2f_5;
            *row[2] = output_state_id_col2;
            *sub_component_inputs.memory_address_to_id[2] = ((instance_addr_tmp_7cd2f_0) + (M31_2));
            *lookup_data.memory_address_to_id_2 = [
                M31_1444891767,
                ((instance_addr_tmp_7cd2f_0) + (M31_2)),
...
//
// GENERATED by tools/witness_genericize for `pedersen_builtin` — mechanical rewrite of
...
//     pedersen_aggregator_window_bits_18_3[4] 9..12
//     mults_0 13
//     (14 words)
//   SUB-INPUT words:
...
//     pedersen_aggregator_window_bits_18[0] 3..5
//     (6 words)
...
pub(crate) const N_LOOKUP_WORDS: usize = 14;
pub(crate) const N_SUB_INPUT_WORDS: usize = 6;

/// The per-row `pedersen_builtin` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn pedersen_builtin_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let seq = eval.iota();
    let wg_v0 = eval.m31_mul(seq, m31_3);
    let wg_v1 = eval.input(0);
    let instance_addr_tmp_7cd2f_0 = eval.m31_add(wg_v0, wg_v1);
    let memory_address_to_id_value_tmp_7cd2f_1 = eval.mem_addr_to_id(instance_addr_tmp_7cd2f_0);
    let input_state_0_id_col0 = memory_address_to_id_value_tmp_7cd2f_1;
    eval.set_col(0, input_state_0_id_col0);
    eval.set_sub_input_word(0, instance_addr_tmp_7cd2f_0);
    eval.set_lookup_word(0, m31_1444891767);
    eval.set_lookup_word(1, instance_addr_tmp_7cd2f_0);
    eval.set_lookup_word(2, input_state_0_id_col0);
    let wg_v2 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_1);
    let memory_address_to_id_value_tmp_7cd2f_3 = eval.mem_addr_to_id(wg_v2);
    let input_state_1_id_col1 = memory_address_to_id_value_tmp_7cd2f_3;
    eval.set_col(1, input_state_1_id_col1);
    let wg_v3 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_1);
    eval.set_sub_input_word(1, wg_v3);
    eval.set_lookup_word(3, m31_1444891767);
    let wg_v4 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_1);
    eval.set_lookup_word(4, wg_v4);
    eval.set_lookup_word(5, input_state_1_id_col1);
    let wg_v5 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_2);
    let memory_address_to_id_value_tmp_7cd2f_5 = eval.mem_addr_to_id(wg_v5);
    let output_state_id_col2 = memory_address_to_id_value_tmp_7cd2f_5;
    eval.set_col(2, output_state_id_col2);
    let wg_v6 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_2);
    eval.set_sub_input_word(2, wg_v6);
    eval.set_lookup_word(6, m31_1444891767);
    let wg_v7 = eval.m31_add(instance_addr_tmp_7cd2f_0, m31_2);
    eval.set_lookup_word(7, wg_v7);
    eval.set_lookup_word(8, output_state_id_col2);
    eval.set_sub_input_word(3, input_state_0_id_col0);
    eval.set_sub_input_word(4, input_state_1_id_col1);
    eval.set_sub_input_word(5, output_state_id_col2);
    eval.set_lookup_word(9, m31_520578465);
    eval.set_lookup_word(10, input_state_0_id_col0);
    eval.set_lookup_word(11, input_state_1_id_col1);
    eval.set_lookup_word(12, output_state_id_col2);
    eval.set_lookup_word(13, m31_1);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `pedersen_builtin_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
    ...
    (
        ...
        .for_each(|(row_index, (row, lookup_data, sub_component_inputs))| {
            let mut eval = SimdWitnessEval::new(
                ...
                memory_address_to_id_state,
                None,
                vec![Simd::splat(pedersen_builtin_segment_start)],
                row_index,
                &enabler_col,
                N_LOOKUP_WORDS,
                N_SUB_INPUT_WORDS,
            );
            pedersen_builtin_row_body(&mut eval);
            ...
            *lookup_data.pedersen_aggregator_window_bits_18_3 = [lw[9], lw[10], lw[11], lw[12]];
            *lookup_data.mults_0 = lw[13];
...
/// Record the `pedersen_builtin` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_pedersen_builtin() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::with_slots("pedersen_builtin", 1, Some(2));
    pedersen_builtin_row_body(&mut eval);
    eval.finish()
}
...
crate::jit_lookup_accessor! {
    ...
    pedersen_aggregator_window_bits_18_3: 4,
    mults_0: scalar,
}
...
pub(crate) const JIT_LOGUP_DESCS: &[(&str, &str, bool, &str, &str, bool)] = &[
    ...
    (
        ...
        "mults_0",
        false,
        "pedersen_aggregator_window_bits_18_3",
        "mults_0",
        false,
    ),
];
...
fn lookup_data_flat(ld: &LookupData) -> Vec<Vec<PackedM31>> {
    vec![
        ...
        ld.memory_address_to_id_2
            ...
            .copied()
            .collect(),
        ld.pedersen_aggregator_window_bits_18_3
            .iter()
            .flatten()
            .copied()
            .collect(),
...
fn sub_inputs_flat(sci: &SubComponentInputs) -> Vec<Vec<Simd<u32, N_LANES>>> {
    vec![
        ...
        sci.memory_address_to_id[2]
            ...
            .map(|v| v.into_simd())
            .collect::<Vec<_>>(),
        sci.pedersen_aggregator_window_bits_18[0]
            .iter()
            .flat_map(|t| vec![t.0[0].into_simd(), t.0[1].into_simd(), t.1.into_simd()])
            .collect::<Vec<_>>(),
    ]
}
...
pub(crate) fn generic_simd_diff(
    ...
    let (trace_o, ld_o, sci_o) = write_trace_simd(
        log_size.clone(),
        pedersen_builtin_segment_start.clone(),
        memory_address_to_id_state,
        pedersen_aggregator_window_bits_18_state,
    );
