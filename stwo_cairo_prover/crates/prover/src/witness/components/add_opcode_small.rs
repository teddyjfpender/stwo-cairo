...
fn add_opcode_small_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 1);
    ...
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 1);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 7);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 2);
    let wg_v10 = eval.u16_from_m31(wg_v9);
    let wg_v11 = eval.u16_shl(wg_v10, 2);
    let wg_v12 = eval.u16_add(wg_v8, wg_v11);
    let wg_v13 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 3);
    ...
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 3);
    let wg_v18 = eval.u16_from_m31(wg_v17);
    let wg_v19 = eval.u16_shr(wg_v18, 5);
    let wg_v20 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 4);
    let wg_v21 = eval.u16_from_m31(wg_v20);
    let wg_v22 = eval.u16_shl(wg_v21, 4);
    let wg_v23 = eval.u16_add(wg_v19, wg_v22);
    let wg_v24 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    ...
    let wg_v28 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    let wg_v29 = eval.u16_from_m31(wg_v28);
    let wg_v30 = eval.u16_shr(wg_v29, 3);
    let wg_v31 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 6);
    ...
    let wg_v36 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    let wg_v37 = eval.u16_from_m31(wg_v36);
    let wg_v38 = eval.u16_shr(wg_v37, 3);
    let wg_v39 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 6);
    ...
    let wg_v44 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    let wg_v45 = eval.u16_from_m31(wg_v44);
    let wg_v46 = eval.u16_shr(wg_v45, 3);
    let wg_v47 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 6);
    ...
    let wg_v52 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    let wg_v53 = eval.u16_from_m31(wg_v52);
    let wg_v54 = eval.u16_shr(wg_v53, 3);
    let wg_v55 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 6);
    ...
    let wg_v61 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 5);
    let wg_v62 = eval.u16_from_m31(wg_v61);
    let wg_v63 = eval.u16_shr(wg_v62, 3);
    let wg_v64 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_1, 6);
    ...
    let wg_v109 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 27);
    let msb_tmp_e5099_15 = eval.m31_eq(wg_v109, m31_256);
    let msb_col15 = eval.mask_as_m31(msb_tmp_e5099_15);
    eval.set_col(15, msb_col15);
    let wg_v110 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 20);
    ...
    let dst_limb_0_col17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 0);
    eval.set_col(17, dst_limb_0_col17);
    let dst_limb_1_col18 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 1);
    eval.set_col(18, dst_limb_1_col18);
    let dst_limb_2_col19 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 2);
    eval.set_col(19, dst_limb_2_col19);
    let wg_v117 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_14, 3);
    ...
    let wg_v134 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 27);
    let msb_tmp_e5099_25 = eval.m31_eq(wg_v134, m31_256);
    let msb_col23 = eval.mask_as_m31(msb_tmp_e5099_25);
    eval.set_col(23, msb_col23);
    let wg_v135 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 20);
    ...
    let op0_limb_0_col25 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 0);
    eval.set_col(25, op0_limb_0_col25);
    let op0_limb_1_col26 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 1);
    eval.set_col(26, op0_limb_1_col26);
    let op0_limb_2_col27 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 2);
    eval.set_col(27, op0_limb_2_col27);
    let wg_v142 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_24, 3);
    ...
    let wg_v159 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 27);
    let msb_tmp_e5099_35 = eval.m31_eq(wg_v159, m31_256);
    let msb_col31 = eval.mask_as_m31(msb_tmp_e5099_35);
    eval.set_col(31, msb_col31);
    let wg_v160 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 20);
    ...
    let op1_limb_0_col33 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 0);
    eval.set_col(33, op1_limb_0_col33);
    let op1_limb_1_col34 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 1);
    eval.set_col(34, op1_limb_1_col34);
    let op1_limb_2_col35 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 2);
    eval.set_col(35, op1_limb_2_col35);
    let wg_v167 = eval.felt_get_m31(&memory_id_to_big_value_tmp_e5099_34, 3);
