...
fn jnz_opcode_taken_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 1);
    ...
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 5);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 3);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 6);
    ...
    let wg_v14 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 5);
    let wg_v15 = eval.u16_from_m31(wg_v14);
    let wg_v16 = eval.u16_shr(wg_v15, 3);
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_1, 6);
    ...
    let dst_limb_0_col8 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 0);
    eval.set_col(8, dst_limb_0_col8);
    let dst_limb_1_col9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 1);
    eval.set_col(9, dst_limb_1_col9);
    let dst_limb_2_col10 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 2);
    eval.set_col(10, dst_limb_2_col10);
    let dst_limb_3_col11 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 3);
    eval.set_col(11, dst_limb_3_col11);
    let dst_limb_4_col12 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 4);
    eval.set_col(12, dst_limb_4_col12);
    let dst_limb_5_col13 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 5);
    eval.set_col(13, dst_limb_5_col13);
    let dst_limb_6_col14 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 6);
    eval.set_col(14, dst_limb_6_col14);
    let dst_limb_7_col15 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 7);
    eval.set_col(15, dst_limb_7_col15);
    let dst_limb_8_col16 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 8);
    eval.set_col(16, dst_limb_8_col16);
    let dst_limb_9_col17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 9);
    eval.set_col(17, dst_limb_9_col17);
    let dst_limb_10_col18 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 10);
    eval.set_col(18, dst_limb_10_col18);
    let dst_limb_11_col19 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 11);
    eval.set_col(19, dst_limb_11_col19);
    let dst_limb_12_col20 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 12);
    eval.set_col(20, dst_limb_12_col20);
    let dst_limb_13_col21 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 13);
    eval.set_col(21, dst_limb_13_col21);
    let dst_limb_14_col22 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 14);
    eval.set_col(22, dst_limb_14_col22);
    let dst_limb_15_col23 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 15);
    eval.set_col(23, dst_limb_15_col23);
    let dst_limb_16_col24 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 16);
    eval.set_col(24, dst_limb_16_col24);
    let dst_limb_17_col25 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 17);
    eval.set_col(25, dst_limb_17_col25);
    let dst_limb_18_col26 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 18);
    eval.set_col(26, dst_limb_18_col26);
    let dst_limb_19_col27 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 19);
    eval.set_col(27, dst_limb_19_col27);
    let dst_limb_20_col28 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 20);
    eval.set_col(28, dst_limb_20_col28);
    let dst_limb_21_col29 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 21);
    eval.set_col(29, dst_limb_21_col29);
    let dst_limb_22_col30 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 22);
    eval.set_col(30, dst_limb_22_col30);
    let dst_limb_23_col31 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 23);
    eval.set_col(31, dst_limb_23_col31);
    let dst_limb_24_col32 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 24);
    eval.set_col(32, dst_limb_24_col32);
    let dst_limb_25_col33 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 25);
    eval.set_col(33, dst_limb_25_col33);
    let dst_limb_26_col34 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 26);
    eval.set_col(34, dst_limb_26_col34);
    let dst_limb_27_col35 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_8, 27);
    ...
    let wg_v74 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 27);
    let msb_tmp_7f087_18 = eval.m31_eq(wg_v74, m31_256);
    let msb_col39 = eval.mask_as_m31(msb_tmp_7f087_18);
    eval.set_col(39, msb_col39);
    let wg_v75 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 20);
    ...
    let next_pc_limb_0_col41 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 0);
    eval.set_col(41, next_pc_limb_0_col41);
    let next_pc_limb_1_col42 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 1);
    eval.set_col(42, next_pc_limb_1_col42);
    let next_pc_limb_2_col43 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 2);
    eval.set_col(43, next_pc_limb_2_col43);
    let wg_v82 = eval.felt_get_m31(&memory_id_to_big_value_tmp_7f087_17, 3);
