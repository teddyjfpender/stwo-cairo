...
#![allow(unused_parens)]
use cairo_air::components::jnz_opcode_non_taken::{Claim, InteractionClaim, N_TRACE_COLUMNS};
...
fn write_trace_simd(
    ...
    (
        ...
        .enumerate()
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, jnz_opcode_non_taken_input))| {
                let input_pc_col0 = jnz_opcode_non_taken_input.pc;
                *row[0] = input_pc_col0;
                let input_ap_col1 = jnz_opcode_non_taken_input.ap;
                *row[1] = input_ap_col1;
                let input_fp_col2 = jnz_opcode_non_taken_input.fp;
                *row[2] = input_fp_col2;

                // Decode Instruction.

                let memory_address_to_id_value_tmp_59be2_0 =
                    memory_address_to_id_state.deduce_output(input_pc_col0);
                let memory_id_to_big_value_tmp_59be2_1 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_59be2_0);
                let offset0_tmp_59be2_2 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_59be2_1.get_m31(0)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_59be2_1.get_m31(1),
                        )) & (UInt16_127))
                            << (UInt16_9)));
                let offset0_col3 = offset0_tmp_59be2_2.as_m31();
                *row[3] = offset0_col3;
                let dst_base_fp_tmp_59be2_3 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_59be2_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_59be2_1.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_0))
                        & (UInt16_1));
                let dst_base_fp_col4 = dst_base_fp_tmp_59be2_3.as_m31();
                *row[4] = dst_base_fp_col4;
                let ap_update_add_1_tmp_59be2_4 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_59be2_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_59be2_1.get_m31(6),
                        ...
                        >> (UInt16_11))
                        & (UInt16_1));
                let ap_update_add_1_col5 = ap_update_add_1_tmp_59be2_4.as_m31();
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let decode_instruction_ad440_output_tmp_59be2_5 = (
                ...
                *row[6] = mem_dst_base_col6;
                ...
                let memory_address_to_id_value_tmp_59be2_6 = memory_address_to_id_state
                    .deduce_output(
                        ((mem_dst_base_col6) + (decode_instruction_ad440_output_tmp_59be2_5.0[0])),
                    );
                let dst_id_col7 = memory_address_to_id_value_tmp_59be2_6;
                *row[7] = dst_id_col7;
                ...
                *lookup_data.memory_id_to_big_2 = [
                ...
                let enabler_col8 = enabler_col.packed_at(row_index);
                *row[8] = enabler_col8;
                ...
                *lookup_data.mults_1 = enabler_col8;
            },
        );
...
//
// GENERATED by tools/witness_genericize for `jnz_opcode_non_taken` — mechanical rewrite of
...
/// The per-row `jnz_opcode_non_taken` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn jnz_opcode_non_taken_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let memory_address_to_id_value_tmp_59be2_0 = eval.mem_addr_to_id(input_pc_col0);
    let memory_id_to_big_value_tmp_59be2_1 =
        eval.mem_id_to_value(memory_address_to_id_value_tmp_59be2_0);
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 1);
    let wg_v3 = eval.u16_from_m31(wg_v2);
    let wg_v4 = eval.u16_and(wg_v3, 127);
    let wg_v5 = eval.u16_shl(wg_v4, 9);
    let offset0_tmp_59be2_2 = eval.u16_add(wg_v1, wg_v5);
    let offset0_col3 = eval.u16_as_m31(offset0_tmp_59be2_2);
    eval.set_col(3, offset0_col3);
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 5);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 3);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 6);
    ...
    let dst_base_fp_tmp_59be2_3 = eval.u16_and(wg_v13, 1);
    let dst_base_fp_col4 = eval.u16_as_m31(dst_base_fp_tmp_59be2_3);
    eval.set_col(4, dst_base_fp_col4);
    let wg_v14 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 5);
    let wg_v15 = eval.u16_from_m31(wg_v14);
    let wg_v16 = eval.u16_shr(wg_v15, 3);
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1, 6);
    ...
    let ap_update_add_1_tmp_59be2_4 = eval.u16_and(wg_v21, 1);
    let ap_update_add_1_col5 = eval.u16_as_m31(ap_update_add_1_tmp_59be2_4);
    ...
    let wg_v36 = eval.m31_add(
        mem_dst_base_col6,
        decode_instruction_ad440_output_tmp_59be2_5.0[0],
    );
    let memory_address_to_id_value_tmp_59be2_6 = eval.mem_addr_to_id(wg_v36);
    let dst_id_col7 = memory_address_to_id_value_tmp_59be2_6;
    ...
    eval.set_sub_input_word(8, dst_id_col7);
    eval.set_lookup_word(11, m31_1662111297);
    eval.set_lookup_word(12, dst_id_col7);
    eval.set_lookup_word(13, m31_0);
    eval.set_lookup_word(14, m31_0);
    eval.set_lookup_word(15, m31_0);
    eval.set_lookup_word(16, m31_0);
    ...
    let enabler_col8 = eval.enabler();
    eval.set_col(8, enabler_col8);
    ...
    let wg_v39 = eval.m31_add(input_pc_col0, m31_2);
    eval.set_lookup_word(46, wg_v39);
    let wg_v40 = eval.m31_add(input_ap_col1, ap_update_add_1_col5);
    eval.set_lookup_word(47, wg_v40);
    eval.set_lookup_word(48, input_fp_col2);
    eval.set_lookup_word(49, m31_1);
    eval.set_lookup_word(50, enabler_col8);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `jnz_opcode_non_taken_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, jnz_opcode_non_taken_input))| {
                let mut eval = SimdWitnessEval::new(
                    ...
                    memory_address_to_id_state,
                    memory_id_to_big_state,
                    jnz_opcode_non_taken_input,
                    row_index,
                    &enabler_col,
                    N_LOOKUP_WORDS,
                    N_SUB_INPUT_WORDS,
                );
                jnz_opcode_non_taken_row_body(&mut eval);
...
/// Record the `jnz_opcode_non_taken` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_jnz_opcode_non_taken() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::new("jnz_opcode_non_taken");
    jnz_opcode_non_taken_row_body(&mut eval);
    eval.finish()
}
