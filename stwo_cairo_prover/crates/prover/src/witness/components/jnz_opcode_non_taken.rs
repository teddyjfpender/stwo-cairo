...
fn jnz_opcode_non_taken_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 1);
    ...
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 5);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 3);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 6);
    ...
    let wg_v14 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 5);
    let wg_v15 = eval.u16_from_m31(wg_v14);
    let wg_v16 = eval.u16_shr(wg_v15, 3);
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_59be2_1.clone(), 6);
