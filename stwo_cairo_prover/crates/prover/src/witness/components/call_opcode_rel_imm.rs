        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, call_opcode_rel_imm_input))| {
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let stored_fp_id_col3 = memory_address_to_id_value_tmp_82d62_3;
                ...
                *lookup_data.memory_address_to_id_1 =
                ...
                let stored_fp_limb_0_col4 = memory_id_to_big_value_tmp_82d62_5.get_m31(0);
                *row[4] = stored_fp_limb_0_col4;
                let stored_fp_limb_1_col5 = memory_id_to_big_value_tmp_82d62_5.get_m31(1);
                *row[5] = stored_fp_limb_1_col5;
                let stored_fp_limb_2_col6 = memory_id_to_big_value_tmp_82d62_5.get_m31(2);
                *row[6] = stored_fp_limb_2_col6;
                let stored_fp_limb_3_col7 = memory_id_to_big_value_tmp_82d62_5.get_m31(3);
                *row[7] = stored_fp_limb_3_col7;
                ...
                let partial_limb_msb_col8 = partial_limb_msb_tmp_82d62_6.as_m31();
                ...
                *lookup_data.memory_id_to_big_2 = [
                ...
                let stored_ret_pc_id_col9 = memory_address_to_id_value_tmp_82d62_10;
                ...
                *lookup_data.memory_address_to_id_3 = [
                ...
                let stored_ret_pc_limb_0_col10 = memory_id_to_big_value_tmp_82d62_12.get_m31(0);
                *row[10] = stored_ret_pc_limb_0_col10;
                let stored_ret_pc_limb_1_col11 = memory_id_to_big_value_tmp_82d62_12.get_m31(1);
                *row[11] = stored_ret_pc_limb_1_col11;
                let stored_ret_pc_limb_2_col12 = memory_id_to_big_value_tmp_82d62_12.get_m31(2);
                *row[12] = stored_ret_pc_limb_2_col12;
                let stored_ret_pc_limb_3_col13 = memory_id_to_big_value_tmp_82d62_12.get_m31(3);
                *row[13] = stored_ret_pc_limb_3_col13;
                ...
                let partial_limb_msb_tmp_82d62_13 =
                    (((PackedUInt16::from_m31(stored_ret_pc_limb_3_col13)) & (UInt16_2))
                        >> (UInt16_1));
                let partial_limb_msb_col14 = partial_limb_msb_tmp_82d62_13.as_m31();
                ...
                *lookup_data.memory_id_to_big_4 = [
                ...
                let distance_to_next_pc_id_col15 = memory_address_to_id_value_tmp_82d62_17;
                ...
                *lookup_data.memory_address_to_id_5 = [
                ...
                let msb_col16 = msb_tmp_82d62_20.as_m31();
                *row[16] = msb_col16;
                let mid_limbs_set_tmp_82d62_21 =
                    ((memory_id_to_big_value_tmp_82d62_19.get_m31(20).eq(M31_511))
                        & (msb_tmp_82d62_20));
                let mid_limbs_set_col17 = mid_limbs_set_tmp_82d62_21.as_m31();
                ...
                *row[20] = distance_to_next_pc_limb_2_col20;
                let remainder_bits_tmp_82d62_23 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_82d62_19.get_m31(3)))
                        & (UInt16_3));
                let remainder_bits_col21 = remainder_bits_tmp_82d62_23.as_m31();
                *row[21] = remainder_bits_col21;
                ...
                let partial_limb_msb_col22 = partial_limb_msb_tmp_82d62_24.as_m31();
                ...
                *lookup_data.memory_id_to_big_6 = [
                    ...
                    ((remainder_bits_col21) + (decode_small_sign_output_tmp_82d62_22[2])),
                ...
                let enabler_col23 = enabler_col.packed_at(row_index);
                *row[23] = enabler_col23;
                *lookup_data.opcodes_7 =
                    [M31_428564188, input_pc_col0, input_ap_col1, input_fp_col2];
                *lookup_data.opcodes_8 = [
                    M31_428564188,
                    ((input_pc_col0) + (read_small_output_tmp_82d62_26.0)),
                    ((input_ap_col1) + (M31_2)),
                    ((input_ap_col1) + (M31_2)),
                ];
                *lookup_data.mults_0 = M31_1;
                *lookup_data.mults_1 = enabler_col23;
            },
        );
...
//
// GENERATED by tools/witness_genericize for `call_opcode_rel_imm` — mechanical rewrite of
...
/// The per-row `call_opcode_rel_imm` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn call_opcode_rel_imm_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let memory_address_to_id_value_tmp_82d62_0 = eval.mem_addr_to_id(input_pc_col0);
    let memory_id_to_big_value_tmp_82d62_1 =
        eval.mem_id_to_value(memory_address_to_id_value_tmp_82d62_0);
    ...
    eval.set_sub_input_word(4, m31_32);
    eval.set_sub_input_word(5, m31_68);
    ...
    eval.set_lookup_word(5, m31_32);
    eval.set_lookup_word(6, m31_68);
    eval.set_lookup_word(7, m31_0);
    let decode_instruction_e4e14_output_tmp_82d62_2 = (
        [m31_0, m31_1, m31_1],
        [
            m31_0, m31_0, m31_1, m31_0, m31_0, m31_0, m31_0, m31_0, m31_1, m31_0, m31_0, m31_0,
            m31_1, m31_0, m31_0,
        ],
        m31_0,
    );
    let memory_address_to_id_value_tmp_82d62_3 = eval.mem_addr_to_id(input_ap_col1);
    let stored_fp_id_col3 = memory_address_to_id_value_tmp_82d62_3;
    eval.set_col(3, stored_fp_id_col3);
    eval.set_sub_input_word(7, input_ap_col1);
    eval.set_lookup_word(8, m31_1444891767);
    eval.set_lookup_word(9, input_ap_col1);
    eval.set_lookup_word(10, stored_fp_id_col3);
    let memory_id_to_big_value_tmp_82d62_5 = eval.mem_id_to_value(stored_fp_id_col3);
    let stored_fp_limb_0_col4 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_5.clone(), 0);
    eval.set_col(4, stored_fp_limb_0_col4);
    let stored_fp_limb_1_col5 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_5.clone(), 1);
    eval.set_col(5, stored_fp_limb_1_col5);
    let stored_fp_limb_2_col6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_5.clone(), 2);
    eval.set_col(6, stored_fp_limb_2_col6);
    let stored_fp_limb_3_col7 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_5.clone(), 3);
    eval.set_col(7, stored_fp_limb_3_col7);
    let wg_v0 = eval.u16_from_m31(stored_fp_limb_3_col7);
    let wg_v1 = eval.u16_and(wg_v0, 2);
    let partial_limb_msb_tmp_82d62_6 = eval.u16_shr(wg_v1, 1);
    let partial_limb_msb_col8 = eval.u16_as_m31(partial_limb_msb_tmp_82d62_6);
    eval.set_col(8, partial_limb_msb_col8);
    eval.set_sub_input_word(10, stored_fp_id_col3);
    eval.set_lookup_word(11, m31_1662111297);
    eval.set_lookup_word(12, stored_fp_id_col3);
    eval.set_lookup_word(13, stored_fp_limb_0_col4);
    eval.set_lookup_word(14, stored_fp_limb_1_col5);
    eval.set_lookup_word(15, stored_fp_limb_2_col6);
    eval.set_lookup_word(16, stored_fp_limb_3_col7);
    ...
    let read_positive_known_id_num_bits_29_output_tmp_82d62_8 = eval.felt_from_limbs([
        stored_fp_limb_0_col4,
        stored_fp_limb_1_col5,
        stored_fp_limb_2_col6,
        stored_fp_limb_3_col7,
    ...
    let read_positive_num_bits_29_output_tmp_82d62_9 = (
        read_positive_known_id_num_bits_29_output_tmp_82d62_8.clone(),
        stored_fp_id_col3,
    );
    let wg_v2 = eval.m31_add(input_ap_col1, m31_1);
    let memory_address_to_id_value_tmp_82d62_10 = eval.mem_addr_to_id(wg_v2);
    let stored_ret_pc_id_col9 = memory_address_to_id_value_tmp_82d62_10;
    eval.set_col(9, stored_ret_pc_id_col9);
    let wg_v3 = eval.m31_add(input_ap_col1, m31_1);
    eval.set_sub_input_word(8, wg_v3);
    eval.set_lookup_word(41, m31_1444891767);
    let wg_v4 = eval.m31_add(input_ap_col1, m31_1);
    eval.set_lookup_word(42, wg_v4);
    eval.set_lookup_word(43, stored_ret_pc_id_col9);
    let memory_id_to_big_value_tmp_82d62_12 = eval.mem_id_to_value(stored_ret_pc_id_col9);
    let stored_ret_pc_limb_0_col10 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_12.clone(), 0);
    eval.set_col(10, stored_ret_pc_limb_0_col10);
    let stored_ret_pc_limb_1_col11 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_12.clone(), 1);
    eval.set_col(11, stored_ret_pc_limb_1_col11);
    let stored_ret_pc_limb_2_col12 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_12.clone(), 2);
    eval.set_col(12, stored_ret_pc_limb_2_col12);
    let stored_ret_pc_limb_3_col13 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_12.clone(), 3);
    eval.set_col(13, stored_ret_pc_limb_3_col13);
    let wg_v5 = eval.u16_from_m31(stored_ret_pc_limb_3_col13);
    let wg_v6 = eval.u16_and(wg_v5, 2);
    let partial_limb_msb_tmp_82d62_13 = eval.u16_shr(wg_v6, 1);
    let partial_limb_msb_col14 = eval.u16_as_m31(partial_limb_msb_tmp_82d62_13);
    eval.set_col(14, partial_limb_msb_col14);
    eval.set_sub_input_word(11, stored_ret_pc_id_col9);
    eval.set_lookup_word(44, m31_1662111297);
    eval.set_lookup_word(45, stored_ret_pc_id_col9);
    eval.set_lookup_word(46, stored_ret_pc_limb_0_col10);
    eval.set_lookup_word(47, stored_ret_pc_limb_1_col11);
    eval.set_lookup_word(48, stored_ret_pc_limb_2_col12);
    eval.set_lookup_word(49, stored_ret_pc_limb_3_col13);
    ...
    let read_positive_known_id_num_bits_29_output_tmp_82d62_15 = eval.felt_from_limbs([
        stored_ret_pc_limb_0_col10,
        stored_ret_pc_limb_1_col11,
        stored_ret_pc_limb_2_col12,
        stored_ret_pc_limb_3_col13,
    ...
    let read_positive_num_bits_29_output_tmp_82d62_16 = (
        read_positive_known_id_num_bits_29_output_tmp_82d62_15.clone(),
        stored_ret_pc_id_col9,
    );
    let wg_v7 = eval.m31_add(input_pc_col0, m31_1);
    let memory_address_to_id_value_tmp_82d62_17 = eval.mem_addr_to_id(wg_v7);
    let distance_to_next_pc_id_col15 = memory_address_to_id_value_tmp_82d62_17;
    eval.set_col(15, distance_to_next_pc_id_col15);
    let wg_v8 = eval.m31_add(input_pc_col0, m31_1);
    eval.set_sub_input_word(9, wg_v8);
    eval.set_lookup_word(74, m31_1444891767);
    let wg_v9 = eval.m31_add(input_pc_col0, m31_1);
    eval.set_lookup_word(75, wg_v9);
    eval.set_lookup_word(76, distance_to_next_pc_id_col15);
    let memory_id_to_big_value_tmp_82d62_19 = eval.mem_id_to_value(distance_to_next_pc_id_col15);
    let wg_v10 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 27);
    let msb_tmp_82d62_20 = eval.m31_eq(wg_v10, m31_256);
    let msb_col16 = eval.mask_as_m31(msb_tmp_82d62_20);
    eval.set_col(16, msb_col16);
    let wg_v11 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 20);
    let wg_v12 = eval.m31_eq(wg_v11, m31_511);
    let mid_limbs_set_tmp_82d62_21 = eval.mask_and(wg_v12, msb_tmp_82d62_20);
    let mid_limbs_set_col17 = eval.mask_as_m31(mid_limbs_set_tmp_82d62_21);
    eval.set_col(17, mid_limbs_set_col17);
    let wg_v13 = eval.m31_mul(mid_limbs_set_col17, m31_508);
    let wg_v14 = eval.m31_mul(mid_limbs_set_col17, m31_511);
    let wg_v15 = eval.m31_mul(msb_col16, m31_136);
    let wg_v16 = eval.m31_sub(wg_v15, mid_limbs_set_col17);
    let wg_v17 = eval.m31_mul(msb_col16, m31_256);
    let decode_small_sign_output_tmp_82d62_22 = [
        msb_col16,
        mid_limbs_set_col17,
        wg_v13,
    ...
    let distance_to_next_pc_limb_0_col18 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 0);
    eval.set_col(18, distance_to_next_pc_limb_0_col18);
    let distance_to_next_pc_limb_1_col19 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 1);
    eval.set_col(19, distance_to_next_pc_limb_1_col19);
    let distance_to_next_pc_limb_2_col20 =
        eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 2);
    eval.set_col(20, distance_to_next_pc_limb_2_col20);
    let wg_v18 = eval.felt_get_m31(&memory_id_to_big_value_tmp_82d62_19.clone(), 3);
    let wg_v19 = eval.u16_from_m31(wg_v18);
    let remainder_bits_tmp_82d62_23 = eval.u16_and(wg_v19, 3);
    let remainder_bits_col21 = eval.u16_as_m31(remainder_bits_tmp_82d62_23);
    eval.set_col(21, remainder_bits_col21);
    let wg_v20 = eval.u16_from_m31(remainder_bits_col21);
    let wg_v21 = eval.u16_and(wg_v20, 2);
    let partial_limb_msb_tmp_82d62_24 = eval.u16_shr(wg_v21, 1);
    let partial_limb_msb_col22 = eval.u16_as_m31(partial_limb_msb_tmp_82d62_24);
    eval.set_col(22, partial_limb_msb_col22);
    eval.set_sub_input_word(12, distance_to_next_pc_id_col15);
    eval.set_lookup_word(77, m31_1662111297);
    eval.set_lookup_word(78, distance_to_next_pc_id_col15);
    eval.set_lookup_word(79, distance_to_next_pc_limb_0_col18);
    eval.set_lookup_word(80, distance_to_next_pc_limb_1_col19);
    eval.set_lookup_word(81, distance_to_next_pc_limb_2_col20);
    let wg_v22 = eval.m31_add(
        remainder_bits_col21,
        decode_small_sign_output_tmp_82d62_22[2],
    );
    eval.set_lookup_word(82, wg_v22);
    eval.set_lookup_word(83, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(84, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(85, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(86, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(87, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(88, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(89, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(90, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(91, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(92, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(93, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(94, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(95, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(96, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(97, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(98, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(99, decode_small_sign_output_tmp_82d62_22[3]);
    eval.set_lookup_word(100, decode_small_sign_output_tmp_82d62_22[4]);
    ...
    eval.set_lookup_word(106, decode_small_sign_output_tmp_82d62_22[5]);
    let wg_v23 = eval.m31_mul(distance_to_next_pc_limb_1_col19, m31_512);
    let wg_v24 = eval.m31_add(distance_to_next_pc_limb_0_col18, wg_v23);
    let wg_v25 = eval.m31_mul(distance_to_next_pc_limb_2_col20, m31_262144);
    let wg_v26 = eval.m31_add(wg_v24, wg_v25);
    let wg_v27 = eval.m31_mul(remainder_bits_col21, m31_134217728);
    let wg_v28 = eval.m31_add(wg_v26, wg_v27);
    let wg_v29 = eval.m31_sub(wg_v28, msb_col16);
    let wg_v30 = eval.m31_mul(m31_536870912, mid_limbs_set_col17);
    let wg_v31 = eval.m31_sub(wg_v29, wg_v30);
    let read_small_output_tmp_82d62_26 = (wg_v31, distance_to_next_pc_id_col15);
    let enabler_col23 = eval.enabler();
    eval.set_col(23, enabler_col23);
    ...
    let wg_v32 = eval.m31_add(input_pc_col0, read_small_output_tmp_82d62_26.0);
    eval.set_lookup_word(112, wg_v32);
    let wg_v33 = eval.m31_add(input_ap_col1, m31_2);
    eval.set_lookup_word(113, wg_v33);
    let wg_v34 = eval.m31_add(input_ap_col1, m31_2);
    eval.set_lookup_word(114, wg_v34);
    eval.set_lookup_word(115, m31_1);
    eval.set_lookup_word(116, enabler_col23);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `call_opcode_rel_imm_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, call_opcode_rel_imm_input))| {
                let mut eval = SimdWitnessEval::new(
                    ...
                    memory_address_to_id_state,
                    memory_id_to_big_state,
                    call_opcode_rel_imm_input,
                    row_index,
                    &enabler_col,
                    N_LOOKUP_WORDS,
                    N_SUB_INPUT_WORDS,
                );
                call_opcode_rel_imm_row_body(&mut eval);
...
/// Record the `call_opcode_rel_imm` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_call_opcode_rel_imm() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::new("call_opcode_rel_imm");
    call_opcode_rel_imm_row_body(&mut eval);
    eval.finish()
}
