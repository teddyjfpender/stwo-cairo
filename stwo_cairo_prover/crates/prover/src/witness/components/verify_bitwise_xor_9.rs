...
fn write_trace_simd(
    ...
    let bitwise_xor_9_1 = preprocessed_trace.get_column(&PreProcessedColumnId {
        id: "bitwise_xor_9_1".to_owned(),
    });
    let bitwise_xor_9_2 = preprocessed_trace.get_column(&PreProcessedColumnId {
        id: "bitwise_xor_9_2".to_owned(),
    });
