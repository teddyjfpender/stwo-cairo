...
fn add_opcode_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 1);
    ...
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 1);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 7);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 2);
    let wg_v10 = eval.u16_from_m31(wg_v9);
    let wg_v11 = eval.u16_shl(wg_v10, 2);
    let wg_v12 = eval.u16_add(wg_v8, wg_v11);
    let wg_v13 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 3);
    ...
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 3);
    let wg_v18 = eval.u16_from_m31(wg_v17);
    let wg_v19 = eval.u16_shr(wg_v18, 5);
    let wg_v20 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 4);
    let wg_v21 = eval.u16_from_m31(wg_v20);
    let wg_v22 = eval.u16_shl(wg_v21, 4);
    let wg_v23 = eval.u16_add(wg_v19, wg_v22);
    let wg_v24 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    ...
    let wg_v28 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    let wg_v29 = eval.u16_from_m31(wg_v28);
    let wg_v30 = eval.u16_shr(wg_v29, 3);
    let wg_v31 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 6);
    ...
    let wg_v36 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    let wg_v37 = eval.u16_from_m31(wg_v36);
    let wg_v38 = eval.u16_shr(wg_v37, 3);
    let wg_v39 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 6);
    ...
    let wg_v44 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    let wg_v45 = eval.u16_from_m31(wg_v44);
    let wg_v46 = eval.u16_shr(wg_v45, 3);
    let wg_v47 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 6);
    ...
    let wg_v52 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    let wg_v53 = eval.u16_from_m31(wg_v52);
    let wg_v54 = eval.u16_shr(wg_v53, 3);
    let wg_v55 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 6);
    ...
    let wg_v61 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 5);
    let wg_v62 = eval.u16_from_m31(wg_v61);
    let wg_v63 = eval.u16_shr(wg_v62, 3);
    let wg_v64 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_1, 6);
    ...
    let dst_limb_0_col15 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 0);
    eval.set_col(15, dst_limb_0_col15);
    let dst_limb_1_col16 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 1);
    eval.set_col(16, dst_limb_1_col16);
    let dst_limb_2_col17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 2);
    eval.set_col(17, dst_limb_2_col17);
    let dst_limb_3_col18 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 3);
    eval.set_col(18, dst_limb_3_col18);
    let dst_limb_4_col19 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 4);
    eval.set_col(19, dst_limb_4_col19);
    let dst_limb_5_col20 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 5);
    eval.set_col(20, dst_limb_5_col20);
    let dst_limb_6_col21 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 6);
    eval.set_col(21, dst_limb_6_col21);
    let dst_limb_7_col22 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 7);
    eval.set_col(22, dst_limb_7_col22);
    let dst_limb_8_col23 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 8);
    eval.set_col(23, dst_limb_8_col23);
    let dst_limb_9_col24 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 9);
    eval.set_col(24, dst_limb_9_col24);
    let dst_limb_10_col25 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 10);
    eval.set_col(25, dst_limb_10_col25);
    let dst_limb_11_col26 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 11);
    eval.set_col(26, dst_limb_11_col26);
    let dst_limb_12_col27 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 12);
    eval.set_col(27, dst_limb_12_col27);
    let dst_limb_13_col28 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 13);
    eval.set_col(28, dst_limb_13_col28);
    let dst_limb_14_col29 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 14);
    eval.set_col(29, dst_limb_14_col29);
    let dst_limb_15_col30 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 15);
    eval.set_col(30, dst_limb_15_col30);
    let dst_limb_16_col31 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 16);
    eval.set_col(31, dst_limb_16_col31);
    let dst_limb_17_col32 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 17);
    eval.set_col(32, dst_limb_17_col32);
    let dst_limb_18_col33 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 18);
    eval.set_col(33, dst_limb_18_col33);
    let dst_limb_19_col34 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 19);
    eval.set_col(34, dst_limb_19_col34);
    let dst_limb_20_col35 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 20);
    eval.set_col(35, dst_limb_20_col35);
    let dst_limb_21_col36 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 21);
    eval.set_col(36, dst_limb_21_col36);
    let dst_limb_22_col37 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 22);
    eval.set_col(37, dst_limb_22_col37);
    let dst_limb_23_col38 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 23);
    eval.set_col(38, dst_limb_23_col38);
    let dst_limb_24_col39 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 24);
    eval.set_col(39, dst_limb_24_col39);
    let dst_limb_25_col40 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 25);
    eval.set_col(40, dst_limb_25_col40);
    let dst_limb_26_col41 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 26);
    eval.set_col(41, dst_limb_26_col41);
    let dst_limb_27_col42 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_14, 27);
    ...
    let op0_limb_0_col44 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 0);
    eval.set_col(44, op0_limb_0_col44);
    let op0_limb_1_col45 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 1);
    eval.set_col(45, op0_limb_1_col45);
    let op0_limb_2_col46 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 2);
    eval.set_col(46, op0_limb_2_col46);
    let op0_limb_3_col47 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 3);
    eval.set_col(47, op0_limb_3_col47);
    let op0_limb_4_col48 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 4);
    eval.set_col(48, op0_limb_4_col48);
    let op0_limb_5_col49 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 5);
    eval.set_col(49, op0_limb_5_col49);
    let op0_limb_6_col50 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 6);
    eval.set_col(50, op0_limb_6_col50);
    let op0_limb_7_col51 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 7);
    eval.set_col(51, op0_limb_7_col51);
    let op0_limb_8_col52 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 8);
    eval.set_col(52, op0_limb_8_col52);
    let op0_limb_9_col53 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 9);
    eval.set_col(53, op0_limb_9_col53);
    let op0_limb_10_col54 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 10);
    eval.set_col(54, op0_limb_10_col54);
    let op0_limb_11_col55 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 11);
    eval.set_col(55, op0_limb_11_col55);
    let op0_limb_12_col56 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 12);
    eval.set_col(56, op0_limb_12_col56);
    let op0_limb_13_col57 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 13);
    eval.set_col(57, op0_limb_13_col57);
    let op0_limb_14_col58 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 14);
    eval.set_col(58, op0_limb_14_col58);
    let op0_limb_15_col59 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 15);
    eval.set_col(59, op0_limb_15_col59);
    let op0_limb_16_col60 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 16);
    eval.set_col(60, op0_limb_16_col60);
    let op0_limb_17_col61 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 17);
    eval.set_col(61, op0_limb_17_col61);
    let op0_limb_18_col62 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 18);
    eval.set_col(62, op0_limb_18_col62);
    let op0_limb_19_col63 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 19);
    eval.set_col(63, op0_limb_19_col63);
    let op0_limb_20_col64 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 20);
    eval.set_col(64, op0_limb_20_col64);
    let op0_limb_21_col65 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 21);
    eval.set_col(65, op0_limb_21_col65);
    let op0_limb_22_col66 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 22);
    eval.set_col(66, op0_limb_22_col66);
    let op0_limb_23_col67 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 23);
    eval.set_col(67, op0_limb_23_col67);
    let op0_limb_24_col68 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 24);
    eval.set_col(68, op0_limb_24_col68);
    let op0_limb_25_col69 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 25);
    eval.set_col(69, op0_limb_25_col69);
    let op0_limb_26_col70 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 26);
    eval.set_col(70, op0_limb_26_col70);
    let op0_limb_27_col71 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_19, 27);
    ...
    let op1_limb_0_col73 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 0);
    eval.set_col(73, op1_limb_0_col73);
    let op1_limb_1_col74 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 1);
    eval.set_col(74, op1_limb_1_col74);
    let op1_limb_2_col75 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 2);
    eval.set_col(75, op1_limb_2_col75);
    let op1_limb_3_col76 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 3);
    eval.set_col(76, op1_limb_3_col76);
    let op1_limb_4_col77 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 4);
    eval.set_col(77, op1_limb_4_col77);
    let op1_limb_5_col78 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 5);
    eval.set_col(78, op1_limb_5_col78);
    let op1_limb_6_col79 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 6);
    eval.set_col(79, op1_limb_6_col79);
    let op1_limb_7_col80 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 7);
    eval.set_col(80, op1_limb_7_col80);
    let op1_limb_8_col81 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 8);
    eval.set_col(81, op1_limb_8_col81);
    let op1_limb_9_col82 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 9);
    eval.set_col(82, op1_limb_9_col82);
    let op1_limb_10_col83 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 10);
    eval.set_col(83, op1_limb_10_col83);
    let op1_limb_11_col84 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 11);
    eval.set_col(84, op1_limb_11_col84);
    let op1_limb_12_col85 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 12);
    eval.set_col(85, op1_limb_12_col85);
    let op1_limb_13_col86 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 13);
    eval.set_col(86, op1_limb_13_col86);
    let op1_limb_14_col87 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 14);
    eval.set_col(87, op1_limb_14_col87);
    let op1_limb_15_col88 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 15);
    eval.set_col(88, op1_limb_15_col88);
    let op1_limb_16_col89 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 16);
    eval.set_col(89, op1_limb_16_col89);
    let op1_limb_17_col90 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 17);
    eval.set_col(90, op1_limb_17_col90);
    let op1_limb_18_col91 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 18);
    eval.set_col(91, op1_limb_18_col91);
    let op1_limb_19_col92 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 19);
    eval.set_col(92, op1_limb_19_col92);
    let op1_limb_20_col93 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 20);
    eval.set_col(93, op1_limb_20_col93);
    let op1_limb_21_col94 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 21);
    eval.set_col(94, op1_limb_21_col94);
    let op1_limb_22_col95 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 22);
    eval.set_col(95, op1_limb_22_col95);
    let op1_limb_23_col96 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 23);
    eval.set_col(96, op1_limb_23_col96);
    let op1_limb_24_col97 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 24);
    eval.set_col(97, op1_limb_24_col97);
    let op1_limb_25_col98 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 25);
    eval.set_col(98, op1_limb_25_col98);
    let op1_limb_26_col99 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 26);
    eval.set_col(99, op1_limb_26_col99);
    let op1_limb_27_col100 = eval.felt_get_m31(&memory_id_to_big_value_tmp_d5af5_24, 27);
