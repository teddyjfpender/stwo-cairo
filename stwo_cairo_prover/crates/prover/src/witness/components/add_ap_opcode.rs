...
fn write_trace_simd(
    ...
    (
        ...
        .enumerate()
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, add_ap_opcode_input))| {
                ...
                *row[2] = input_fp_col2;
                ...
                let memory_address_to_id_value_tmp_44683_0 =
                    memory_address_to_id_state.deduce_output(input_pc_col0);
                let memory_id_to_big_value_tmp_44683_1 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_44683_0);
                let offset2_tmp_44683_2 =
                    ((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_44683_1.get_m31(3)))
                        >> (UInt16_5))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_44683_1.get_m31(4),
                        )) << (UInt16_4)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_44683_1.get_m31(5),
                        )) & (UInt16_7))
                            << (UInt16_13)));
                let offset2_col3 = offset2_tmp_44683_2.as_m31();
                *row[3] = offset2_col3;
                let op1_imm_tmp_44683_3 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_44683_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_44683_1.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_2))
                        & (UInt16_1));
                let op1_imm_col4 = op1_imm_tmp_44683_3.as_m31();
                *row[4] = op1_imm_col4;
                let op1_base_fp_tmp_44683_4 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_44683_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_44683_1.get_m31(6),
                        ...
                        >> (UInt16_3))
                        & (UInt16_1));
                let op1_base_fp_col5 = op1_base_fp_tmp_44683_4.as_m31();
                *row[5] = op1_base_fp_col5;
                let op1_base_ap_tmp_44683_5 = (((M31_1) - (op1_imm_col4)) - (op1_base_fp_col5));
                *sub_component_inputs.verify_instruction[0] = (
                    ...
                    [
                        ((((M31_24) + ((op1_imm_col4) * (M31_32)))
                            ...
                            + ((op1_base_ap_tmp_44683_5) * (M31_128))),
                        M31_16,
                    ],
                    M31_0,
                );
                *lookup_data.verify_instruction_0 = [
                ...
                let decode_instruction_89ffb_output_tmp_44683_6 = (
                    [
                        M31_2147483646,
                        M31_2147483646,
                ...
                let mem1_base_col6 = ((((op1_imm_col4) * (input_pc_col0))
                    ...
                    + ((decode_instruction_89ffb_output_tmp_44683_6.1[4]) * (input_ap_col1)));
                *row[6] = mem1_base_col6;
                ...
                let memory_address_to_id_value_tmp_44683_7 = memory_address_to_id_state
                    .deduce_output(
                        ((mem1_base_col6) + (decode_instruction_89ffb_output_tmp_44683_6.0[2])),
                    );
                let op1_id_col7 = memory_address_to_id_value_tmp_44683_7;
                *row[7] = op1_id_col7;
                ...
                *lookup_data.memory_address_to_id_1 = [
                ...
                let memory_id_to_big_value_tmp_44683_9 =
                    memory_id_to_big_state.deduce_output(op1_id_col7);

                // Decode Small Sign.

                let msb_tmp_44683_10 = memory_id_to_big_value_tmp_44683_9.get_m31(27).eq(M31_256);
                let msb_col8 = msb_tmp_44683_10.as_m31();
                *row[8] = msb_col8;
                let mid_limbs_set_tmp_44683_11 =
                    ((memory_id_to_big_value_tmp_44683_9.get_m31(20).eq(M31_511))
                        & (msb_tmp_44683_10));
                let mid_limbs_set_col9 = mid_limbs_set_tmp_44683_11.as_m31();
                *row[9] = mid_limbs_set_col9;
                let decode_small_sign_output_tmp_44683_12 = [
                    msb_col8,
                    mid_limbs_set_col9,
                ...
                let op1_limb_0_col10 = memory_id_to_big_value_tmp_44683_9.get_m31(0);
                *row[10] = op1_limb_0_col10;
                let op1_limb_1_col11 = memory_id_to_big_value_tmp_44683_9.get_m31(1);
                *row[11] = op1_limb_1_col11;
                let op1_limb_2_col12 = memory_id_to_big_value_tmp_44683_9.get_m31(2);
                *row[12] = op1_limb_2_col12;
                let remainder_bits_tmp_44683_13 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_44683_9.get_m31(3)))
                        & (UInt16_3));
                let remainder_bits_col13 = remainder_bits_tmp_44683_13.as_m31();
                *row[13] = remainder_bits_col13;

                // Cond Range Check 2.

                let partial_limb_msb_tmp_44683_14 =
                    (((PackedUInt16::from_m31(remainder_bits_col13)) & (UInt16_2)) >> (UInt16_1));
                let partial_limb_msb_col14 = partial_limb_msb_tmp_44683_14.as_m31();
                ...
                *lookup_data.memory_id_to_big_2 = [
                    ...
                    op1_limb_1_col11,
                    op1_limb_2_col12,
                    ((remainder_bits_col13) + (decode_small_sign_output_tmp_44683_12[2])),
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[3],
                    ...
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[3],
                    decode_small_sign_output_tmp_44683_12[4],
                    M31_0,
                    M31_0,
                    M31_0,
                    M31_0,
                    M31_0,
                    decode_small_sign_output_tmp_44683_12[5],
                ];
                let read_small_output_tmp_44683_16 = (
                ...
                let next_ap_tmp_44683_17 = ((input_ap_col1) + (read_small_output_tmp_44683_16.0));

                // Range Check 29.

                let range_check_29_bot11bits_u32_tmp_44683_18 =
                    ((PackedUInt32::from_m31(next_ap_tmp_44683_17)) & (UInt32_2047));
                let range_check_29_bot11bits_col15 =
                    range_check_29_bot11bits_u32_tmp_44683_18.low().as_m31();
                *row[15] = range_check_29_bot11bits_col15;
                *sub_component_inputs.range_check_18[0] = [(((next_ap_tmp_44683_17)
                    - (range_check_29_bot11bits_col15))
                    * (M31_1048576))];
                *lookup_data.range_check_18_3 = [
                    M31_1109051422,
                    (((next_ap_tmp_44683_17) - (range_check_29_bot11bits_col15)) * (M31_1048576)),
                ];
                *sub_component_inputs.range_check_11[0] = [range_check_29_bot11bits_col15];
                *lookup_data.range_check_11_4 = [M31_991608089, range_check_29_bot11bits_col15];

                let enabler_col16 = enabler_col.packed_at(row_index);
                *row[16] = enabler_col16;
                ...
                *lookup_data.mults_1 = enabler_col16;
            },
        );
...
//
// GENERATED by tools/witness_genericize for `add_ap_opcode` — mechanical rewrite of
...
//     range_check_18_3[2] 41..42
//     range_check_11_4[2] 43..44
//     opcodes_5[4] 45..48
//     opcodes_6[4] 49..52
//     mults_0 53
//     mults_1 54
...
pub(crate) const N_LOOKUP_WORDS: usize = 55;
pub(crate) const N_SUB_INPUT_WORDS: usize = 11;

/// The per-row `add_ap_opcode` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn add_ap_opcode_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let m31_1048576 = eval.m31_const(1048576);
    ...
    let memory_address_to_id_value_tmp_44683_0 = eval.mem_addr_to_id(input_pc_col0);
    let memory_id_to_big_value_tmp_44683_1 =
        eval.mem_id_to_value(memory_address_to_id_value_tmp_44683_0);
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 3);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.u16_shr(wg_v1, 5);
    let wg_v3 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 4);
    let wg_v4 = eval.u16_from_m31(wg_v3);
    let wg_v5 = eval.u16_shl(wg_v4, 4);
    let wg_v6 = eval.u16_add(wg_v2, wg_v5);
    let wg_v7 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 5);
    let wg_v8 = eval.u16_from_m31(wg_v7);
    let wg_v9 = eval.u16_and(wg_v8, 7);
    let wg_v10 = eval.u16_shl(wg_v9, 13);
    let offset2_tmp_44683_2 = eval.u16_add(wg_v6, wg_v10);
    let offset2_col3 = eval.u16_as_m31(offset2_tmp_44683_2);
    eval.set_col(3, offset2_col3);
    let wg_v11 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 5);
    let wg_v12 = eval.u16_from_m31(wg_v11);
    let wg_v13 = eval.u16_shr(wg_v12, 3);
    let wg_v14 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 6);
    let wg_v15 = eval.u16_from_m31(wg_v14);
    let wg_v16 = eval.u16_shl(wg_v15, 6);
    let wg_v17 = eval.u16_add(wg_v13, wg_v16);
    let wg_v18 = eval.u16_shr(wg_v17, 2);
    let op1_imm_tmp_44683_3 = eval.u16_and(wg_v18, 1);
    let op1_imm_col4 = eval.u16_as_m31(op1_imm_tmp_44683_3);
    eval.set_col(4, op1_imm_col4);
    let wg_v19 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 5);
    let wg_v20 = eval.u16_from_m31(wg_v19);
    let wg_v21 = eval.u16_shr(wg_v20, 3);
    let wg_v22 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_1.clone(), 6);
    let wg_v23 = eval.u16_from_m31(wg_v22);
    let wg_v24 = eval.u16_shl(wg_v23, 6);
    let wg_v25 = eval.u16_add(wg_v21, wg_v24);
    let wg_v26 = eval.u16_shr(wg_v25, 3);
    let op1_base_fp_tmp_44683_4 = eval.u16_and(wg_v26, 1);
    let op1_base_fp_col5 = eval.u16_as_m31(op1_base_fp_tmp_44683_4);
    eval.set_col(5, op1_base_fp_col5);
    let wg_v27 = eval.m31_sub(m31_1, op1_imm_col4);
    let op1_base_ap_tmp_44683_5 = eval.m31_sub(wg_v27, op1_base_fp_col5);
    let wg_v28 = eval.m31_mul(op1_imm_col4, m31_32);
    let wg_v29 = eval.m31_add(m31_24, wg_v28);
    let wg_v30 = eval.m31_mul(op1_base_fp_col5, m31_64);
    let wg_v31 = eval.m31_add(wg_v29, wg_v30);
    let wg_v32 = eval.m31_mul(op1_base_ap_tmp_44683_5, m31_128);
    ...
    eval.set_sub_input_word(4, wg_v33);
    eval.set_sub_input_word(5, m31_16);
    ...
    let wg_v34 = eval.m31_mul(op1_imm_col4, m31_32);
    let wg_v35 = eval.m31_add(m31_24, wg_v34);
    let wg_v36 = eval.m31_mul(op1_base_fp_col5, m31_64);
    let wg_v37 = eval.m31_add(wg_v35, wg_v36);
    let wg_v38 = eval.m31_mul(op1_base_ap_tmp_44683_5, m31_128);
    let wg_v39 = eval.m31_add(wg_v37, wg_v38);
    eval.set_lookup_word(5, wg_v39);
    eval.set_lookup_word(6, m31_16);
    eval.set_lookup_word(7, m31_0);
    let wg_v40 = eval.m31_sub(offset2_col3, m31_32768);
    let decode_instruction_89ffb_output_tmp_44683_6 = (
        [m31_2147483646, m31_2147483646, wg_v40],
        [
            m31_1,
            m31_1,
            op1_imm_col4,
    ...
    let wg_v41 = eval.m31_mul(op1_imm_col4, input_pc_col0);
    let wg_v42 = eval.m31_mul(op1_base_fp_col5, input_fp_col2);
    let wg_v43 = eval.m31_add(wg_v41, wg_v42);
    let wg_v44 = eval.m31_mul(
        decode_instruction_89ffb_output_tmp_44683_6.1[4],
        input_ap_col1,
    );
    ...
    let wg_v45 = eval.m31_add(
        mem1_base_col6,
        decode_instruction_89ffb_output_tmp_44683_6.0[2],
    );
    let memory_address_to_id_value_tmp_44683_7 = eval.mem_addr_to_id(wg_v45);
    let op1_id_col7 = memory_address_to_id_value_tmp_44683_7;
    eval.set_col(7, op1_id_col7);
    ...
    eval.set_lookup_word(10, op1_id_col7);
    let memory_id_to_big_value_tmp_44683_9 = eval.mem_id_to_value(op1_id_col7);
    let wg_v48 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 27);
    let msb_tmp_44683_10 = eval.m31_eq(wg_v48, m31_256);
    let msb_col8 = eval.mask_as_m31(msb_tmp_44683_10);
    eval.set_col(8, msb_col8);
    let wg_v49 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 20);
    let wg_v50 = eval.m31_eq(wg_v49, m31_511);
    let mid_limbs_set_tmp_44683_11 = eval.mask_and(wg_v50, msb_tmp_44683_10);
    let mid_limbs_set_col9 = eval.mask_as_m31(mid_limbs_set_tmp_44683_11);
    ...
    let op1_limb_0_col10 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 0);
    eval.set_col(10, op1_limb_0_col10);
    let op1_limb_1_col11 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 1);
    eval.set_col(11, op1_limb_1_col11);
    let op1_limb_2_col12 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 2);
    eval.set_col(12, op1_limb_2_col12);
    let wg_v56 = eval.felt_get_m31(&memory_id_to_big_value_tmp_44683_9.clone(), 3);
    let wg_v57 = eval.u16_from_m31(wg_v56);
    let remainder_bits_tmp_44683_13 = eval.u16_and(wg_v57, 3);
    let remainder_bits_col13 = eval.u16_as_m31(remainder_bits_tmp_44683_13);
    eval.set_col(13, remainder_bits_col13);
    let wg_v58 = eval.u16_from_m31(remainder_bits_col13);
    let wg_v59 = eval.u16_and(wg_v58, 2);
    let partial_limb_msb_tmp_44683_14 = eval.u16_shr(wg_v59, 1);
    let partial_limb_msb_col14 = eval.u16_as_m31(partial_limb_msb_tmp_44683_14);
    eval.set_col(14, partial_limb_msb_col14);
    eval.set_sub_input_word(8, op1_id_col7);
    eval.set_lookup_word(11, m31_1662111297);
    eval.set_lookup_word(12, op1_id_col7);
    eval.set_lookup_word(13, op1_limb_0_col10);
    eval.set_lookup_word(14, op1_limb_1_col11);
    eval.set_lookup_word(15, op1_limb_2_col12);
    let wg_v60 = eval.m31_add(
        remainder_bits_col13,
        decode_small_sign_output_tmp_44683_12[2],
    );
    eval.set_lookup_word(16, wg_v60);
    eval.set_lookup_word(17, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(18, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(19, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(20, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(21, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(22, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(23, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(24, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(25, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(26, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(27, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(28, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(29, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(30, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(31, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(32, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(33, decode_small_sign_output_tmp_44683_12[3]);
    eval.set_lookup_word(34, decode_small_sign_output_tmp_44683_12[4]);
    ...
    eval.set_lookup_word(40, decode_small_sign_output_tmp_44683_12[5]);
    let wg_v61 = eval.m31_mul(op1_limb_1_col11, m31_512);
    let wg_v62 = eval.m31_add(op1_limb_0_col10, wg_v61);
    let wg_v63 = eval.m31_mul(op1_limb_2_col12, m31_262144);
    ...
    let read_small_output_tmp_44683_16 = (wg_v69, op1_id_col7);
    let next_ap_tmp_44683_17 = eval.m31_add(input_ap_col1, read_small_output_tmp_44683_16.0);
    let wg_v70 = eval.u32_from_m31(next_ap_tmp_44683_17);
    let range_check_29_bot11bits_u32_tmp_44683_18 = eval.u32_and_imm(wg_v70, 2047);
    let wg_v71 = eval.u32_low(range_check_29_bot11bits_u32_tmp_44683_18);
    let range_check_29_bot11bits_col15 = eval.u16_as_m31(wg_v71);
    eval.set_col(15, range_check_29_bot11bits_col15);
    let wg_v72 = eval.m31_sub(next_ap_tmp_44683_17, range_check_29_bot11bits_col15);
    let wg_v73 = eval.m31_mul(wg_v72, m31_1048576);
    eval.set_sub_input_word(9, wg_v73);
    eval.set_lookup_word(41, m31_1109051422);
    let wg_v74 = eval.m31_sub(next_ap_tmp_44683_17, range_check_29_bot11bits_col15);
    let wg_v75 = eval.m31_mul(wg_v74, m31_1048576);
    eval.set_lookup_word(42, wg_v75);
    eval.set_sub_input_word(10, range_check_29_bot11bits_col15);
    eval.set_lookup_word(43, m31_991608089);
    eval.set_lookup_word(44, range_check_29_bot11bits_col15);
    let enabler_col16 = eval.enabler();
    eval.set_col(16, enabler_col16);
    eval.set_lookup_word(45, m31_428564188);
    eval.set_lookup_word(46, input_pc_col0);
    eval.set_lookup_word(47, input_ap_col1);
    eval.set_lookup_word(48, input_fp_col2);
    eval.set_lookup_word(49, m31_428564188);
    let wg_v76 = eval.m31_add(m31_1, op1_imm_col4);
    let wg_v77 = eval.m31_add(input_pc_col0, wg_v76);
    eval.set_lookup_word(50, wg_v77);
    eval.set_lookup_word(51, next_ap_tmp_44683_17);
    eval.set_lookup_word(52, input_fp_col2);
    eval.set_lookup_word(53, m31_1);
    eval.set_lookup_word(54, enabler_col16);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `add_ap_opcode_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
    ...
    (
        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, add_ap_opcode_input))| {
                ...
                add_ap_opcode_row_body(&mut eval);
                ...
                *lookup_data.range_check_18_3 = [lw[41], lw[42]];
                *lookup_data.range_check_11_4 = [lw[43], lw[44]];
                *lookup_data.opcodes_5 = [lw[45], lw[46], lw[47], lw[48]];
                *lookup_data.opcodes_6 = [lw[49], lw[50], lw[51], lw[52]];
                *lookup_data.mults_0 = lw[53];
                *lookup_data.mults_1 = lw[54];
...
/// Record the `add_ap_opcode` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_add_ap_opcode() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::new("add_ap_opcode");
    add_ap_opcode_row_body(&mut eval);
    eval.finish()
}
...
pub(crate) const SUB_FEED_LAYOUT: &[(&str, usize, &str, u32, usize, usize)] = &[
    ...
    ("range_check_18", 0, "range_check_18_state", 0, 9, 1),
    ("range_check_11", 0, "range_check_11_state", 0, 10, 1),
];
...
fn lookup_data_flat(ld: &LookupData) -> Vec<Vec<PackedM31>> {
    vec![
        ...
        ld.range_check_18_3.iter().flatten().copied().collect(),
        ld.range_check_11_4.iter().flatten().copied().collect(),
...
struct LookupData {
    ...
    range_check_11_4: Vec<[PackedM31; 2]>,
...
impl InteractionClaimGenerator {
    pub fn write_interaction_trace(
        ...
        (
            col_gen.par_iter_mut(),
            &self.lookup_data.range_check_11_4,
