        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, assert_eq_opcode_imm_input))| {
                ...
                *row[2] = input_fp_col2;
                ...
                let memory_address_to_id_value_tmp_86a47_0 =
                    memory_address_to_id_state.deduce_output(input_pc_col0);
                let memory_id_to_big_value_tmp_86a47_1 =
                    memory_id_to_big_state.deduce_output(memory_address_to_id_value_tmp_86a47_0);
                let offset0_tmp_86a47_2 =
                    ((PackedUInt16::from_m31(memory_id_to_big_value_tmp_86a47_1.get_m31(0)))
                        + (((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_86a47_1.get_m31(1),
                        )) & (UInt16_127))
                            << (UInt16_9)));
                let offset0_col3 = offset0_tmp_86a47_2.as_m31();
                *row[3] = offset0_col3;
                let dst_base_fp_tmp_86a47_3 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_86a47_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_86a47_1.get_m31(6),
                        )) << (UInt16_6)))
                        >> (UInt16_0))
                        & (UInt16_1));
                let dst_base_fp_col4 = dst_base_fp_tmp_86a47_3.as_m31();
                *row[4] = dst_base_fp_col4;
                let ap_update_add_1_tmp_86a47_4 =
                    (((((PackedUInt16::from_m31(memory_id_to_big_value_tmp_86a47_1.get_m31(5)))
                        >> (UInt16_3))
                        + ((PackedUInt16::from_m31(
                            memory_id_to_big_value_tmp_86a47_1.get_m31(6),
                        ...
                        >> (UInt16_11))
                        & (UInt16_1));
                let ap_update_add_1_col5 = ap_update_add_1_tmp_86a47_4.as_m31();
                ...
                *lookup_data.verify_instruction_0 = [
                ...
                let decode_instruction_324b0_output_tmp_86a47_5 = (
                ...
                *row[6] = mem_dst_base_col6;
                ...
                let memory_address_to_id_value_tmp_86a47_6 = memory_address_to_id_state
                    .deduce_output(
                        ((mem_dst_base_col6) + (decode_instruction_324b0_output_tmp_86a47_5.0[0])),
                    );
                let dst_id_col7 = memory_address_to_id_value_tmp_86a47_6;
                *row[7] = dst_id_col7;
                ...
                *lookup_data.memory_address_to_id_2 =
                    [M31_1444891767, ((input_pc_col0) + (M31_1)), dst_id_col7];
...
//
// GENERATED by tools/witness_genericize for `assert_eq_opcode_imm` — mechanical rewrite of
...
const N_LOOKUP_WORDS: usize = 24;
const N_SUB_INPUT_WORDS: usize = 9;

/// The per-row `assert_eq_opcode_imm` base-trace body, routed through `WitnessEval`.
/// Mechanical transcription of `write_trace_simd`'s per-row closure (baseline above).
#[allow(clippy::identity_op)]
#[allow(clippy::erasing_op)]
#[allow(unused_variables)]
#[allow(dead_code)]
fn assert_eq_opcode_imm_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let ap_update_add_1_tmp_86a47_4 = eval.u16_and(wg_v21, 1);
    let ap_update_add_1_col5 = eval.u16_as_m31(ap_update_add_1_tmp_86a47_4);
    ...
    let wg_v26 = eval.m31_add(wg_v25, m31_256);
    ...
    let wg_v31 = eval.m31_add(wg_v30, m31_256);
    ...
    let wg_v36 = eval.m31_add(
        mem_dst_base_col6,
        decode_instruction_324b0_output_tmp_86a47_5.0[0],
    );
    let memory_address_to_id_value_tmp_86a47_6 = eval.mem_addr_to_id(wg_v36);
    let dst_id_col7 = memory_address_to_id_value_tmp_86a47_6;
    ...
    let wg_v39 = eval.m31_add(input_pc_col0, m31_1);
    eval.set_sub_input_word(8, wg_v39);
    eval.set_lookup_word(11, m31_1444891767);
    let wg_v40 = eval.m31_add(input_pc_col0, m31_1);
    eval.set_lookup_word(12, wg_v40);
    eval.set_lookup_word(13, dst_id_col7);
    ...
    let wg_v41 = eval.m31_add(input_pc_col0, m31_2);
    eval.set_lookup_word(19, wg_v41);
    let wg_v42 = eval.m31_add(input_ap_col1, ap_update_add_1_col5);
    eval.set_lookup_word(20, wg_v42);
    eval.set_lookup_word(21, input_fp_col2);
    eval.set_lookup_word(22, m31_1);
    eval.set_lookup_word(23, enabler_col8);
}

/// Generic SIMD driver: same allocation as `write_trace_simd`, but each row runs
/// `assert_eq_opcode_imm_row_body` on a per-row `SimdWitnessEval`, then reconstructs the concrete
        ...
        .for_each(
            |(row_index, (row, lookup_data, sub_component_inputs, assert_eq_opcode_imm_input))| {
                let mut eval = SimdWitnessEval::new(
                    ...
                    memory_address_to_id_state,
                    memory_id_to_big_state,
                    assert_eq_opcode_imm_input,
                    row_index,
                    &enabler_col,
                    N_LOOKUP_WORDS,
                    N_SUB_INPUT_WORDS,
                );
                assert_eq_opcode_imm_row_body(&mut eval);
...
/// Record the `assert_eq_opcode_imm` per-row body into witness-JIT bytecode
...
#[allow(dead_code)]
pub(crate) fn record_assert_eq_opcode_imm() -> RecordingOutput {
    let mut eval = RecordingWitnessEval::new("assert_eq_opcode_imm");
    assert_eq_opcode_imm_row_body(&mut eval);
    eval.finish()
}
