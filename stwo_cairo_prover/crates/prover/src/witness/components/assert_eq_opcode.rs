...
fn assert_eq_opcode_row_body<E: WitnessEval>(eval: &mut E) {
    ...
    let wg_v0 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 0);
    let wg_v1 = eval.u16_from_m31(wg_v0);
    let wg_v2 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 1);
    ...
    let wg_v6 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 3);
    let wg_v7 = eval.u16_from_m31(wg_v6);
    let wg_v8 = eval.u16_shr(wg_v7, 5);
    let wg_v9 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 4);
    let wg_v10 = eval.u16_from_m31(wg_v9);
    let wg_v11 = eval.u16_shl(wg_v10, 4);
    let wg_v12 = eval.u16_add(wg_v8, wg_v11);
    let wg_v13 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 5);
    ...
    let wg_v17 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 5);
    let wg_v18 = eval.u16_from_m31(wg_v17);
    let wg_v19 = eval.u16_shr(wg_v18, 3);
    let wg_v20 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 6);
    ...
    let wg_v25 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 5);
    let wg_v26 = eval.u16_from_m31(wg_v25);
    let wg_v27 = eval.u16_shr(wg_v26, 3);
    let wg_v28 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 6);
    ...
    let wg_v33 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 5);
    let wg_v34 = eval.u16_from_m31(wg_v33);
    let wg_v35 = eval.u16_shr(wg_v34, 3);
    let wg_v36 = eval.felt_get_m31(&memory_id_to_big_value_tmp_36a9d_1, 6);
