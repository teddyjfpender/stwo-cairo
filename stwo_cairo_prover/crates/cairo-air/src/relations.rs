...
// A unique ID for each relation, used to separate tuples of different relations
// used / yielded using the common lookup elements.
// These were generated by hashing the relation name.
