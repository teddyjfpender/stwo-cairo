...
pub(super) fn compile_monolithic(fixture: Fixture) -> Result<FleetProofPlan, FleetCompileError> {
...
pub(super) fn recompile(mut fixture: Fixture, input: CompiledProofInput) -> Fixture {
...
pub(super) fn with_required_alias(fixture: Fixture) -> Fixture {
    let mut input = fixture.compiled.input().clone();
...
pub(super) fn alias_ranges(fixture: &Fixture) -> (ValueRange, ValueRange) {
    fixture
        .compiled
        .effect_for(OpId(0))
        .unwrap()
...
pub(super) fn with_late_source_read(fixture: Fixture) -> Fixture {
    let fixture = with_required_alias(fixture);
